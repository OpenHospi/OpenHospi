        ...
        facetedFilters={[
          {
            columnId: "status",
            title: "Status",
            options: ["pending", "reviewing", "resolved", "dismissed"].map((s) => ({
              label: tEnums(`report_status.${s}` as Parameters<typeof tEnums>[0]),
              value: s,
            })),
          },
          {
            columnId: "reportType",
            title: "Type",
            options: ["message", "user", "room"].map((s) => ({
              label: tEnums(`report_type.${s}` as Parameters<typeof tEnums>[0]),
              value: s,
            })),
          },
        ]}
