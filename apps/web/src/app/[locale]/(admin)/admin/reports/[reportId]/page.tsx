                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            <ReportStatusSelector reportId={report.id} currentStatus={report.status as ReportStatus}/>
                        </div>
                        <div>
                                    ...
                                    <RoomDetailDialog room={roomDetail}>
                                        <button
                                            ...
                                            {roomDetail.coverPhotoUrl && (
                                                <div
                                                    className="relative size-10 shrink-0 overflow-hidden rounded ring-2 ring-transparent group-hover:ring-primary/20 transition-all">
                                                    <StorageImage
