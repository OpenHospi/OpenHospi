        ...
        <View style={styles.contentPadding}>
          ...
          {status !== RoomStatus.draft && (
            <GroupedSection inset={false}>
              <ListCell
                ...
                onPress={() =>
                  router.push({
                    pathname: '/(app)/my-rooms/[id]/applicants',
                    params: { id },
                  })
                }
              />
              ...
              <ListCell
                ...
                onPress={() =>
                  router.push({
                    pathname: '/(app)/my-rooms/[id]/events',
                    params: { id },
                  })
                }
              />
              ...
              <ListCell
                ...
                onPress={() =>
                  router.push({
                    pathname: '/(app)/my-rooms/[id]/voting',
                    params: { id },
                  })
                }
              />
          ...
          <GroupedSection inset={false}>
            ...
            <ListCell
              ...
              onPress={() =>
                router.push({
                  pathname: '/(app)/my-rooms/[id]/share-link',
                  params: { id },
                })
              }
            />
        ...
        <BlurBottomBar style={styles.bottomRow}>
          ...
          <View style={styles.flex1}>
            <ThemedButton
              ...
              onPress={() =>
                router.push({
                  pathname: '/(app)/my-rooms/[id]/close-room',
                  params: { id },
                })
              }>
              {t('actions.close')}
