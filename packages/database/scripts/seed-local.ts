...
await seed(db, schema, { seed: 42 }).refine((f) => ({
  ...
  rooms: {
    ...
    columns: {
      ...
      preferredLifestyleTags: f.valuesFromArray({
        values: [
          ["sociable", "cooking", "tidy"],
          ["quiet", "studying", "tidy"],
          ["sociable", "creative", "inclusive"],
          ["sports", "early_bird", "tidy"],
          ["sociable", "studying"],
          ["quiet", "sustainable", "reading"],
          ["sociable", "nightlife", "cooking"],
          ["tidy", "quiet", "sustainable"],
          ["sociable", "cooking", "inclusive"],
          ["creative", "sociable", "music"],
          ["sociable", "studying", "cooking"],
          ["quiet", "studying"],
          ["sociable", "international", "cooking"],
          ["sociable", "sports", "tidy"],
          ["tidy", "quiet"],
          ["sociable", "cooking"],
          ["studying", "tidy"],
          ["creative", "sociable", "music"],
          ["sociable", "cooking", "sports"],
          ["tidy", "studying", "sustainable"],
        ],
      }),
    },
    with: {
