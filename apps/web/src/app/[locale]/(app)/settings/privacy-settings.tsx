...
import { Download, FileSpreadsheet, History, Loader2, Send, Shield, ShieldOff } from "lucide-react";
...
import { exportData, exportDataCSV } from "./actions";
import {
  getActiveConsents,
  getConsentHistory,
          ...
          {showHistory && (
            <div className="space-y-2">
              {consentHistoryRecords.length === 0 ? (
                <p className="text-muted-foreground text-sm">{t("privacy.consentHistory.empty")}</p>
              ) : (
