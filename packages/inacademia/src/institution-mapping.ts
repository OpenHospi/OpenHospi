...
export const INSTITUTION_MAP = new Map<string, InstitutionInfo>([
  ...
  [
    "https://sts.windows.net/27d137e5-761f-4dc1-af88-d26430abb18f/",
    {
      short: "WUR",
      name: {
        nl: "Wageningen University & Research (WUR)",
  ...
  [
    "https://sts.windows.net/a2586b9b-f867-4b3c-9363-5b435c5dbc45/",
    {
      short: "HHS",
      name: {
        nl: "De Haagse Hogeschool (HHS)",
        en: "The Hague University of Applied Sciences (THUAS)",
      },
    },
  ],
  [
  ...
  [
    "http://adfs.hvhl.nl/adfs/services/trust",
    {
      short: "VHL",
      name: {
        nl: "Hogeschool Van Hall Larenstein",
        en: "Van Hall Larenstein, University of Applied Sciences",
      },
    },
  ],
  [
  ...
  [
    "https://sts.windows.net/6572d2c2-3e99-4784-a466-235eb1d580e9/",
    {
      ...
      name: {
        ...
        en: "Amsterdam University of the Arts",
      },
    },
  ],
  [
  ...
  [
    "http://auth.mumc.nl/adfs/services/trust",
    {
      short: "MUMC+",
      name: {
        nl: "Maastricht Universitair Medisch Centrum",
        en: "Maastricht University Medical Center",
      },
    },
  ],
  [
  ...
  [
    "https://sts.windows.net/c908cc46-554c-4131-8653-45522e68e291/",
    {
      short: "ROCvA",
      name: {
        nl: "ROC van Amsterdam - Flevoland en het VOvA",
        en: "ROC van Amsterdam - Flevoland en het VOvA",
      },
    },
  ],
  [
  ...
  [
    "http://idp.ihe.nl/adfs/services/trust",
    {
      short: "IHE Delft",
      name: {
        nl: "IHE Delft Institute for Water Education",
        en: "IHE Delft Institute for Water Education",
      },
    },
  ],
  [
